...
interface FocusAreaCardGridProps {
  cards: Array<{
    title: string;
    subtitle: string;
    image: string;
...
export function FocusAreaCardGrid({ cards }: FocusAreaCardGridProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join industry-specific discussions and connect with peers in your field.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cards.map((card, index) => (
            <Link
              key={index}
              href={card.url}
              className="group block bg-white rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-200 p-6"
            >
