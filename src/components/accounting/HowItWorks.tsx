...
const steps = [
  {
    icon: UserPlusIcon,
    title: "Lead lands",
    description: "CRM entry + automatic lead scoring & assignment",
    step: "1",
  },
  {
    icon: CalendarIcon,
    title: "Books intro call",
    description: "Calendar + Zoom link created; confirmation emails sent",
    step: "2",
  },
  {
    icon: DocumentCheckIcon,
    title: "Pre-meeting intake/KYC",
    description: "Digital forms, e-sign, identity verification completed",
    step: "3",
  },
  {
    icon: VideoCameraIcon,
    title: "Meeting held",
    description: "AI meeting summary + tasks auto-generated and assigned",
    step: "4",
  },
  {
    icon: DocumentTextIcon,
    title: "Docs flow via SecureVault",
    description: "Checklists complete as documents are received",
    step: "5",
  },
  {
    icon: CheckCircleIcon,
    title: "Engagement runs",
    description: "Invoices, reminders, dashboards, retention policies active",
    step: "6",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See how our automation handles every step of your accounting workflow.
          </p>
        </div>
