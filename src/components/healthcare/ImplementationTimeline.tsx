...
const milestones = [
  {
    ...
    description: "Map workflows, systems and goals",
    step: "1",
  },
  {
    icon: CogIcon,
    title: "Configuration",
    description: "Set forms, rules, roles, permissions",
    step: "2",
  },
  {
    icon: LinkIcon,
    title: "Integration & Import",
    description: "Connect existing systems, migrate priority data",
    step: "3",
  },
  {
    icon: PlayIcon,
    title: "Pilot",
    description: "Live user test (UAT), refine process",
    step: "4",
  },
  {
    icon: RocketLaunchIcon,
    title: "Go-Live & Optimize",
    description: "Launch, monitor, iterate and scale",
    step: "5",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Typical single-site onboarding completes in weeks; multi-site roll-out in phases
          </p>
          <p className="text-lg text-emerald-600 font-medium mt-4">
            Most single-site roll-outs finish within weeks; multi-site may take longer.
          </p>
        </div>
