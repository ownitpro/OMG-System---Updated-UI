...
const securityFeatures = [
  ...
  },
  {
    ...
    description: "With least-privilege principles",
  },
  {
    icon: DocumentTextIcon,
    title: "Immutable audit logs",
    description: "For all actions/access",
  },
  {
    icon: CloudArrowUpIcon,
    title: "PHIPA/PIPEDA-compliance",
    description: "Automated backups, secure API integrations",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-emerald-100 max-w-3xl mx-auto">
            Your healthcare data is protected with enterprise-level security and Canadian compliance.
          </p>
        </div>
