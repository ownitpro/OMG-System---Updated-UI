    ...
    <section id="securevault-docs" className="relative py-20 bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {documentIcons.map((icon) => (
          ...
          >
            <div className="w-12 h-12 bg-teal-500/20 rounded-lg backdrop-blur-sm flex items-center justify-center transform rotate-12 border border-teal-500/30">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 opacity-30">
          <div className="w-full h-full bg-gradient-to-br from-teal-500 to-cyan-600 rounded-full blur-3xl animate-pulse"></div>
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl border border-teal-500/20 p-8 md:p-12" style={{ boxShadow: '0 0 40px rgba(20, 184, 166, 0.15)' }}>
          {/* Header */}
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group inline-flex items-center px-4 py-2 bg-teal-500/10 hover:bg-teal-500/20 rounded-full border border-teal-500/30 transition-all duration-400 ease-premium-out hover:scale-105 cursor-pointer"
                >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-bold rounded-xl hover:from-teal-600 hover:to-cyan-600 transition-all duration-600 ease-premium-out transform hover:scale-105 shadow-lg shadow-teal-500/30 hover:shadow-[0_0_30px_rgba(20,184,166,0.5)]"
            >
              Get Started Free
            ...
            <Link
              ...
              className="inline-flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white border-2 border-teal-500/50 font-bold rounded-xl hover:bg-white/20 hover:border-teal-500 transition-all duration-600 ease-premium-out transform hover:scale-105"
            >
              Try the Live Demo
              <ArrowRightIcon className="w-5 h-5 ml-2" />
            </Link>
