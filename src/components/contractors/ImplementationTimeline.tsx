...
const timelineSteps = [
  {
    ...
    description: "Configure templates, pricing, and workflows",
    step: "1",
  },
  {
    icon: LinkIcon,
    title: "Lead Integration",
    description: "Connect ads, landing pages, intake forms",
    step: "2",
  },
  {
    icon: UserGroupIcon,
    title: "Client Migration",
    description: "Import existing clients and project data",
    step: "3",
  },
  {
    icon: AcademicCapIcon,
    title: "Team Training",
    description: "Train staff on new processes & tools",
    step: "4",
  },
  {
    icon: RocketLaunchIcon,
    title: "Go-Live & Optimize",
    description: "Launch with ongoing support and optimisation",
    step: "5",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A structured approach to implementing your Project Growth Engine.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-lg text-gray-700 max-w-4xl mx-auto">
            <span className="font-semibold">Typical contractor onboarding</span> completes in 1–3 weeks; complex operations may take longer.
          </p>
        </div>
      </div>
