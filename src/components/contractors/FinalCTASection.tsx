...
export default function FinalCTASection() {
  const handleTryDemo = () => {
    trackCTAClick('See Contractor Demo', 'Final CTA Section');
    ...
    <section className="py-20 bg-gradient-to-r from-emerald-600 to-blue-700 text-white text-center">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-extrabold mb-6 leading-tight">
          Build Your Contractor Growth Engine
        </h2>
        <p className="text-xl md:text-2xl max-w-2xl mx-auto mb-10">
          Join thousands of Ontario contractors already using OMGsystems to grow their business with less admin.
        </p>
