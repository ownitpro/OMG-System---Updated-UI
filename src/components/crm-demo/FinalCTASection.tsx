  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-16 h-16 bg-sky-500/10 rounded-full animate-pulse"></div>
        <div className="absolute top-40 right-20 w-12 h-12 bg-sky-400/10 rounded-lg animate-bounce"></div>
        <div className="absolute bottom-40 left-20 w-20 h-20 bg-blue-500/10 rounded-full animate-pulse delay-1000"></div>
        <div className="absolute bottom-20 right-10 w-14 h-14 bg-sky-500/10 rounded-lg animate-bounce delay-500"></div>
      </div>

      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-12 border border-sky-500/20 shadow-[0_0_40px_rgba(14,165,233,0.15)]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <button
              ...
              disabled={isLoading}
              className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-all duration-600 ease-premium-out transform hover:scale-105 shadow-[0_0_20px_rgba(14,165,233,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
            ...
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 border border-white/20 text-lg font-medium rounded-lg text-white bg-white/5 hover:bg-white/10 hover:border-sky-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-all duration-600 ease-premium-out"
            >
