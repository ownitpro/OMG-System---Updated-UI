      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 border border-white/10 hover:border-[#47BD79]/30 transition-all duration-300"
            >
              <div className="mb-4">
                <div className="flex text-[#47BD79] mb-3">
                  {[...Array(5)].map((_, i) => (
              ...
              <div className="border-t border-white/10 pt-4">
                <div className="flex items-center mb-3">
                  <div className="w-10 h-10 bg-[#47BD79]/20 rounded-full flex items-center justify-center border border-[#47BD79]/30">
                    <span className="text-[#47BD79] font-bold text-sm">
                ...
                <div className="bg-[#47BD79]/20 text-[#47BD79] px-3 py-1 rounded-full text-sm font-medium inline-block border border-[#47BD79]/30">
                  {testimonial.stats}
                </div>
              </div>
            </div>
