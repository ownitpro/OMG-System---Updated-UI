      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="flex items-center space-x-8 md:space-x-16 opacity-30">
          ...
          <div className="text-center animate-pulse">
            <div className="w-16 h-16 md:w-20 md:h-20 bg-blue-600 rounded-lg flex items-center justify-center mb-2 shadow-lg shadow-blue-500/20">
          ...
          <div className="text-center animate-pulse" style={{ animationDelay: '1s' }}>
            <div className="w-16 h-16 md:w-20 md:h-20 bg-indigo-600 rounded-lg flex items-center justify-center mb-2 shadow-lg shadow-indigo-500/20">
              <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="text-center animate-pulse" style={{ animationDelay: '1.5s' }}>
            <div className="w-16 h-16 md:w-20 md:h-20 bg-blue-500 rounded-lg flex items-center justify-center mb-2 shadow-lg shadow-blue-400/20">
              <svg className="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <button className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl">
