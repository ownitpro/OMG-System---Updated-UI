...
const steps = [
  {
    icon: UserPlusIcon,
    title: "Lead Captured",
    description: "Via Meta ad or form, enters CRM automatically",
    step: "1",
  },
  {
  ...
  },
  {
    ...
    description: "Mobile updates + photo uploads from site",
    step: "4",
  },
  {
    icon: CurrencyDollarIcon,
    title: "Invoice Auto-Issued + Review Request Sent",
    description: "Payment processed, instant feedback request triggered",
    step: "5",
  },
  {
    icon: ChartBarIcon,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See how our automation handles every step of your cleaning workflow.
          </p>
        </div>
