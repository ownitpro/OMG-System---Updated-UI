...
const metrics = [
  {
    icon: ClockIcon,
    value: "↑ 60%",
    label: "Faster Job Scheduling",
    description: "AI auto-assigns and updates shifts",
  ...
  },
  {
    ...
    description: "Automated reminders for clients & staff",
    color: "text-blue-600",
    bgColor: "bg-blue-50",
  },
  {
    ...
    value: "↑ 50%",
    label: "More Reviews",
    description: "Post-job feedback automation",
  ...
  },
  {
    ...
    description: "Predictable recurring contracts",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See the measurable impact of automation on your cleaning business.
          </p>
        </div>
            ...
            >
              ...
              <div className="text-3xl font-bold text-gray-900 mb-2">
                {metric.value.includes('%') && visibleMetrics.has(index) 
                  ? `${metric.value.includes('↑') ? '↑' : metric.value.includes('↓') ? '↓' : ''}${animatedValues[index]}%` 
                  : metric.value}
              </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-500 mb-4">Trusted by Canadian cleaning teams</p>
          <div className="flex justify-center items-center space-x-8 opacity-60">
            ...
            <div className="text-xs font-medium text-gray-400">✓ Bank-Level Security</div>
          </div>
        </div>
      </div>
