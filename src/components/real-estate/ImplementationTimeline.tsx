...
const timelineSteps = [
  {
    ...
    title: "Discovery",
    description: "import contacts, connect MLS/CRM",
    week: "Week 1",
  },
  {
    icon: CogIcon,
    title: "Build automations & review pipeline setup",
    description: "configure workflows and integrations",
    week: "Week 2",
  },
  {
    icon: RocketLaunchIcon,
    title: "Launch & live testing",
    description: "go live with real data and workflows",
    week: "Week 3",
  },
  {
    icon: ChartBarIcon,
    title: "Optimize, scale ad funnels, onboard full team",
    description: "fine-tune performance and expand usage",
    week: "Week 4",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl mb-4">
            Get up and running in 4 weeks or less
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            A structured approach to implementing your Property Performance Engine.
          </p>
        </div>
          ...
          <div className="relative">
            ...
            <div className="absolute top-8 left-0 right-0 h-2 bg-gray-200 rounded-full">
              <div 
                ...
                style={{ width: `${((activeWeek + 1) / timelineSteps.length) * 100}%` }}
              ></div>
            </div>
