...
const steps = [
  ...
  },
  {
    ...
    description: "SecureVault Docs handles contracts & compliance",
    step: "4",
  },
  {
    icon: HeartIcon,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl mb-4">
            From first click to closing — and beyond
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See how our automation handles every step of your real estate workflow.
          </p>
        </div>
