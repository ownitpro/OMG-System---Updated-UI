...
export default function HeroSection() {
  ...
  const handleTryDemo = () => {
    // Navigate to demo page with real estate industry pre-selected
    window.location.href = "/try-live-demo?industry=real-estate";
  };
    ...
    <section className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-white py-20 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-20">
        <svg className="w-full h-full" fill="none" viewBox="0 0 100 100">
          <defs>
            <linearGradient id="realEstateAnimGradient" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="rgba(255,255,255,0.1)" />
              <stop offset="100%" stopColor="rgba(255,255,255,0.05)" />
            </linearGradient>
          </defs>
          {/* Animated deal flow: Lead → Listing → Closed */}
          ...
          <text x="47" y="35" fontSize="3" fill="white" opacity="0.8">Listing</text>
          ...
          <text x="82" y="35" fontSize="3" fill="white" opacity="0.8">Closed</text>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-clamp-h1 font-extrabold tracking-tight leading-tight mb-4">
          Property Performance Engine™
        </h1>
        <p className="mt-4 text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed mb-8">
          Close More Deals with Less Work — Built for Realtors, by Automation Experts.
        </p>
