  ...
  return (
    ...
    >
      ...
      <section className="relative z-10 overflow-hidden pt-20">
        ...
        <div className="absolute left-0 top-[20%] -translate-x-[15%] w-[350px] md:w-[450px] lg:w-[550px] pointer-events-none hidden md:block opacity-60">
          <Image
            src="/Accounting.png"
        ...
        <div className="absolute right-0 top-[20%] translate-x-[15%] w-[350px] md:w-[450px] lg:w-[550px] pointer-events-none hidden md:block opacity-60">
          <Image
            src="/Accounting.png"
            alt="Accounting documents"
            width={550}
        ...
        >
          ...
          <nav className="mt-8 mb-auto">
            <div
              className="inline-flex items-center px-2 py-1 rounded-full backdrop-blur-xl border border-white/20 shadow-glass"
              style={{
                background:
          ...
          <div className="relative space-y-8">
            {/* Main Headline */}
            <h1
              className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-normal italic leading-[1.1] text-white"
              style={{
                fontFamily:
            ...
            <p className="text-sm sm:text-base md:text-lg max-w-3xl mx-auto leading-relaxed text-slate-700 px-4 font-outfit">
              SecureVault Docs automatically organizes client documents, creates
              clean client-year folders, and tracks due dates and recurring
              obligations — so deadlines don&apos;t pile up and nothing gets missed.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div>
              ...
              >
                Accounting doesn&apos;t fail at math. It fails at intake.
              </h2>
            </div>
            ...
            <div className="space-y-6">
              <p className="text-lg sm:text-xl text-slate-700 leading-relaxed font-outfit">
                Accounting work depends on documents arriving on time — and they
                rarely do.
              </p>
              <p className="text-lg sm:text-xl text-slate-700 leading-relaxed font-outfit">
                Clients send files late, incomplete, or scattered across email,
                portals, and folders. Deadlines stack up. Follow-ups multiply.
                Last-minute scrambling becomes normal.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 text-center space-y-4">
            <p className="text-sm sm:text-base font-bold uppercase tracking-widest font-outfit" style={{ color: "#334155" }}>
              The issue isn&apos;t storage.
            </p>
            <p className="text-sm sm:text-base font-bold uppercase tracking-widest font-outfit" style={{ color: "#334155" }}>
              It&apos;s staying ahead of intake, deadlines, and recurring work.
            </p>
            <div className="pt-4">
              <span
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            ...
            >
              ...
              <p
                ...
                style={{ color: "#0f2336" }}
              >
                Clients upload documents through{" "}
                <span className="font-semibold">secure upload links</span> — no
                portals to explain, no email back-and-forth.
              </p>
              <p
                className="text-lg leading-relaxed mt-4"
                style={{ color: "#0f2336" }}
              >
                Files can also come from email, scans, or photos. Everything
                lands in one place.
              </p>
            </div>
            ...
            >
              ...
              <p
                ...
                style={{ color: "#0f2336" }}
              >
                As soon as documents arrive, SecureVault Docs automatically:
              </p>
              <ul
                className="text-lg leading-relaxed mt-2 space-y-1"
                style={{ color: "#0f2336" }}
              >
                <li>• classifies document types</li>
                <li>• extracts key details</li>
                <li>• creates clean folders by client and year</li>
              </ul>
              <p
                className="text-lg leading-relaxed mt-4"
                style={{ color: "#0f2336" }}
              >
                No manual sorting. No renaming files.
              </p>
            </div>
            ...
            >
              ...
              <p
                ...
                style={{ color: "#0f2336" }}
              >
                If a document includes a due date, recurring obligation, or
                time-sensitive requirement, SecureVault Docs detects it
                automatically.
              </p>
              <p
                className="text-lg leading-relaxed mt-4"
                style={{ color: "#0f2336" }}
              >
                You get alerts before deadlines approach — so work stays
      ...
      {/* Section 4: Built for Real Accounting Workflows */}
      <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-sm font-bold text-slate-700 uppercase tracking-widest font-outfit mb-12">
            Secure Vault Docs supports accounting work across the year:
          </p>
            ...
            <div className="relative w-full max-w-2xl space-y-8">
              ...
              <div className="flex items-center">
                <div className="flex-1 text-right pr-8">
                  <p className="text-lg sm:text-xl md:text-2xl text-white font-medium">
                    Client intake without email chaos
                  </p>
                </div>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1 text-left pl-8">
                  <p className="text-lg sm:text-xl md:text-2xl text-white font-medium">
                    Consistent organization across engagements
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <div className="flex-1 text-right pr-8">
                  <p className="text-lg sm:text-xl md:text-2xl text-white font-medium">
                    Recurring monthly and quarterly workflows
                  </p>
                </div>
                <div className="relative z-10 w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-gradient-to-br from-teal-400 to-cyan-500 shadow-lg shadow-teal-500/30 flex items-center justify-center">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1 text-left pl-8">
                  <p className="text-lg sm:text-xl md:text-2xl text-white font-medium">
                    Year-end and deadline-driven work
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="space-y-6 h-full flex flex-col justify-center">
                ...
                <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
                  ...
                  time — so compliance, renewals, and inspections don&apos;t catch
                  you off guard.
                </p>
                ...
                >
                  <p className="text-sm sm:text-base font-bold text-slate-800 uppercase tracking-wider">
                    That&apos;s the difference between managing files and running a
                    firm efficiently.
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg sm:text-xl mb-4 leading-relaxed font-medium text-white">
                Accounting documents are private, regulated, and critical.
              </p>
