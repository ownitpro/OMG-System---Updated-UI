        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              OMGsystems <span className="text-blue-600">Apps</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {apps.map((app) => (
              ...
              >
                {/* App Icon */}
                <div className={`${app.bgColor} p-6 text-center`}>
                  <div className={`inline-flex items-center justify-center w-16 h-16 ${app.color} rounded-2xl text-2xl mb-4`}>
                    {app.icon}
                  </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-col gap-3">
                    <Link
                      href={app.href}
                      className={`inline-flex items-center justify-center px-4 py-2 ${app.textColor} border border-current rounded-lg font-medium hover:bg-opacity-10 hover:bg-current transition-colors`}
                    >
                      Learn More
                    </Link>
                    <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Deploy in minutes, not months. Get up and running with pre-built industry templates.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Canadian data residency, encryption, and compliance with industry standards.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Loved by Teams</h3>
              <p className="text-gray-600">Intuitive design that your team will actually want to use every day.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {industries.map((industry) => (
              <Link
                key={industry.name}
                href={industry.href}
                className="group p-6 bg-gray-50 rounded-xl hover:bg-blue-50 transition-colors text-center"
              >
