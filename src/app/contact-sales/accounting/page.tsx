...
export default function ContactSalesAccounting() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/contact-sales/accounting", {
        method: "POST",
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                We've received your request for an Accounting strategy call. Our team will reach out within 24 hours to schedule your consultation.
              </p>
              <div className="bg-blue-50 rounded-lg p-4">
                <p className="text-blue-800">
                  <strong>What's next?</strong> We'll review your specific challenges and prepare a customized demo showing how our automation solutions can streamline your accounting processes and improve client service.
                </p>
              </div>
            </div>
          </div>
        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Request a Strategy Call — Accounting
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              Let us show how automation, document management, and smart workflows can help you reduce admin time, improve accuracy, and serve clients better.
            </p>
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
              <p className="text-gray-700">
                Stop drowning in paperwork and manual processes. 
                Transform your accounting practice with automation that handles the routine so you can focus on what matters.
              </p>
            </div>
          </div>
        </Container>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="staffCount" className="block text-sm font-medium text-gray-700 mb-2">
                      Number of Staff / Accountants
                    </label>
                    <select
                      id="staffCount"
                      name="staffCount"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-3">
                    Biggest Bottleneck (Select all that apply)
                  </label>
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      { value: "doc-chasing", label: "Document Chasing" },
                      ...
                      { value: "deadlines", label: "Deadline Management" }
                    ].map((option) => (
                      <label key={option.value} className="flex items-center">
                        <input
                          type="checkbox"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                    placeholder="e.g., QuickBooks, Xero, CaseWare, or Spreadsheets"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                    placeholder="e.g., Reduce manual admin by 50%, faster client onboarding, automated document collection..."
                  />
                </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Workflows designed specifically for accounting</p>
              </div>
              <div className="text-center">
