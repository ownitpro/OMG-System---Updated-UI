      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <div className="mx-auto h-12 w-auto flex items-center justify-center">
            <span className="text-3xl font-bold text-blue-600">OMGsystems</span>
          </div>
                    ...
                    <div key={index} className="flex items-center text-xs">
                      <CheckIcon 
                        className={`h-3 w-3 mr-2 ${
                          passwordChecks[index] ? 'text-green-500' : 'text-gray-300'
                        }`} 
                      />
                      <span className={passwordChecks[index] ? 'text-green-600' : 'text-gray-500'}>
                        {requirement.text}
                      </span>
                    </div>
                  ))}
